...
public class AirlineRepository {
	...
	public static void addToDataBase() {
		...
		FLIGHT_DETAILS.add(new FlightDetails(201, "SpiceJet", "Hyderabad", "Bangalore", 13,LocalDateTime.of(2020, Month.AUGUST, 3, 10, 10, 30),LocalDateTime.of(2020, Month.AUGUST, 3, 11, 10, 30)));
		FLIGHT_DETAILS.add(new FlightDetails(202, "IndiGo", "Delhi", "Mumbai", 10,LocalDateTime.of(2020, Month.JULY,25, 9, 00, 30),LocalDateTime.of(2020, Month.JULY,25, 9, 55, 30)));
		FLIGHT_DETAILS.add(new FlightDetails(203, "GoAir", "Chennai", "Hyderabad", 12,LocalDateTime.of(2020, Month.AUGUST, 13, 10, 10, 30),LocalDateTime.of(2020, Month.AUGUST, 13, 11, 10, 30)));
		FLIGHT_DETAILS.add(new FlightDetails(204, "AirAsia", "Mumbai", "Hyderabad", 8,LocalDateTime.of(2020, Month.SEPTEMBER,15, 10, 10, 30),LocalDateTime.of(2020, Month.SEPTEMBER,15, 12, 10, 30)));
		FLIGHT_DETAILS.add(new FlightDetails(205, "TruJet", "Hyderabad", "Delhi", 10,LocalDateTime.of(2020, Month.OCTOBER, 12, 10, 10, 30),LocalDateTime.of(2020, Month.OCTOBER, 12, 12, 10, 30)));
