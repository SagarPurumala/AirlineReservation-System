				   ...
				   try {
						...
						do {
							try {
								...
								case 7:
									...
									for (BookingStatus request : booking) {
										if (request != null) {
											...
											log.info(
													"Request not found in booking status");
										}
									}
									break;
								case 9:
								...
								default:
									log.info(
											"Invalid Choice please provide 1 or 2 or 3 or 4 or 5 or 6  or 7 or 9");
									break;
								}
							
							} catch (InputMismatchException e) {
								log.error(
										"Invalid entry please provide 1 or 2 or 3 or 4 or 5 or 6  or 7 or 9");
								scanner.nextLine();
							} 
							catch (ARSException e) {
								log.info(e.getMessage());
